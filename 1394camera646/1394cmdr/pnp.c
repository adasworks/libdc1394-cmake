...
Exit_PnpAddDevice:
  ...
  EXIT("t1394Cmdr_PnpAddDevice", ntStatus);
  return(ntStatus);
} // t1394Cmdr_PnpAddDevice
    ...
    )
{
    ...
    switch (IrpSp->MinorFunction) {
        ...
        case IRP_MN_START_DEVICE:
            TRACE(TL_TRACE, ("t1394Cmdr_Pnp: IRP_MN_START_DEVICE\n"));
            ...
            if (!NT_SUCCESS(ntStatus)) {
                ...
                ntStatus = t1394Cmdr_PnpStartDevice(DeviceObject, Irp);
            }
        ...
        case IRP_MN_QUERY_STOP_DEVICE:
            TRACE(TL_TRACE, ("t1394Cmdr_Pnp: IRP_MN_QUERY_STOP_DEVICE\n"));
        ...
        case IRP_MN_STOP_DEVICE:
            TRACE(TL_TRACE, ("t1394Cmdr_Pnp: IRP_MN_STOP_DEVICE\n"));

            ntStatus = t1394Cmdr_PnpStopDevice(DeviceObject, Irp);
        ...
        case IRP_MN_CANCEL_STOP_DEVICE:
            TRACE(TL_TRACE, ("t1394Cmdr_Pnp: IRP_MN_CANCEL_STOP_DEVICE\n"));
        ...
        case IRP_MN_QUERY_REMOVE_DEVICE:
            TRACE(TL_TRACE, ("t1394Cmdr_Pnp: IRP_MN_QUERY_REMOVE_DEVICE\n"));
        ...
        case IRP_MN_SURPRISE_REMOVAL:
            ...
            TRACE(TL_TRACE, ("t1394Cmdr_Pnp: IRP_MN_SURPRISE_REMOVAL\n"));
             
            ntStatus = t1394Cmdr_PnpRemoveDevice(DeviceObject, Irp);
        ...
        case IRP_MN_REMOVE_DEVICE:
            TRACE(TL_TRACE, ("t1394Cmdr_Pnp: IRP_MN_REMOVE_DEVICE\n"));
        ...
        case IRP_MN_CANCEL_REMOVE_DEVICE:
            TRACE(TL_TRACE, ("t1394Cmdr_Pnp: IRP_MN_CANCEL_REMOVE_DEVICE\n"));
        ...
        case IRP_MN_QUERY_CAPABILITIES:
            TRACE(TL_TRACE, ("t1394Cmdr_Pnp: IRP_MN_QUERY_CAPABILITIES\n"));
    ...
    )
{
    ...
    ENTER("t1394Cmdr_PnpStartDevice");
    ...
    EXIT("t1394Cmdr_PnpStartDevice", ntStatus);
    return(ntStatus);
} // t1394Cmdr_PnpStartDevice
    ...
    )
{
    ...
    EXIT("t1394Cmdr_PnpStopDevice", ntStatus);
    return(ntStatus);
} // t1394Cmdr_PnpStopDevice
    ...
    )
{
    ...
    ENTER("t1394Cmdr_PnpRemoveDevice");

    TRACE(TL_CHECK, ("Removing 1394cmdr: %s %s.\n",deviceExtension->VendorName,deviceExtension->ModelName));
    ...
    EXIT("t1394Cmdr_PnpRemoveDevice", ntStatus);
    return(ntStatus);
} // t1394Cmdr_PnpRemoveDevice
